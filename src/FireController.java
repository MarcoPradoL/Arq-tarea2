	...
	public static void main(String args[])
	{
		...
		if (em != null)
		{
			...
			*/
			...
			float WinPosY = 0.55f;	//This is the Y position of the message window in terms 
								 	//of a percentage of the screen height 
			...
			*********************************************************************/
			...
			while ( !Done )
			{
				...
				for ( int i = 0; i < qlen; i++ )
				{
					...
					if ( Evt.GetEventId() == 13 )	//fire event
					{
						if (Evt.GetMessage().equalsIgnoreCase("F1")) // alarm on
						{
							fuego = true;
							mw.WriteMessage("Received Fire detected event" );
						...
						{
							fuego = false;
							mw.WriteMessage("Received Fire ok event" );
