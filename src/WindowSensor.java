...
class WindowSensor
{
		...
		if (em != null)
		{
			...
			*********************************************************************/
			...
			while ( !Done )
			{
				...
				mw.WriteMessage("Current Window state:: " + (windowState ? "BROKEN": "OK"));
	...
	***************************************************************************/
	...
	static private void PostWindowState(EventManagerInterface ei, boolean state )
	{
		// Here we create the event.

		Event evt = new Event( (int) 7, String.valueOf(state) );
